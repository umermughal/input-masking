...
var inputMask = {
    ...
    refresh: function (init) {
        ...
        for (i = 0; i < this.opts.masked.length; i++) {
            ...
            if (!parentClass || ( parentClass && parentClass.indexOf('shell') === -1 )) {
                ...
                if (t.value) {
                    t.previousSibling.innerHTML = this._setValueOfMask(t.value, t.getAttribute('data-placeholder'));
                }
            }
        }
    },
    ...
    setValueOfMask: function (e) {
        ...
        return this._setValueOfMask(value, placeholder);
    },

    _setValueOfMask: function(value, placeholder) {
